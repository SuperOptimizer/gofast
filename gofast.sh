...
cmake -G Ninja "${LLVM_SRC}/llvm" \
  ...
  -DCMAKE_C_FLAGS=" -static -march=native -stdlib=libc++ -fno-unwind-tables -fno-semantic-interposition -fomit-frame-pointer -fno-common " \
  -DCMAKE_CXX_FLAGS=" -static -march=native  -stdlib=libc++ -fno-unwind-tables -fno-semantic-interposition -fomit-frame-pointer -fno-common " \
  -DCMAKE_LINKFLAGS=" -static -stdlib=libc++ -fno-unwind-tables " \
  -DCMAKE_EXE_LINKER_FLAGS=" -static -stdlib=libc++ -fno-unwind-tables " \
  -DCMAKE_SHARED_LINKER_FLAGS=" -static -stdlib=libc++ -fno-unwind-tables " \
...
-DCOMPILER_RT_USE_BUILTINS_LIBRARY=ON \
  ...
  -DLIBUNWIND_USE_COMPILER_RT=ON  \
  -DLIBUNWIND_FORCE_UNWIND_TABLES=ON \
...
cmake -G Ninja "${LLVM_SRC}/llvm" \
  ...
  -DCMAKE_C_FLAGS=" -static -target x86_64-linux-llvm -march=native -stdlib=libc++ --rtlib=compiler-rt -unwind=libunwind -fno-semantic-interposition -fomit-frame-pointer -fno-common " \
  -DCMAKE_CXX_FLAGS=" -static -target x86_64-linux-llvm -march=native  -stdlib=libc++ --rtlib=compiler-rt -unwind=libunwind -fno-semantic-interposition -fomit-frame-pointer -fno-common " \
  -DCMAKE_LINKFLAGS=" -static -target x86_64-linux-llvm -stdlib=libc++ --rtlib=compiler-rt -unwind=libunwind" \
  -DCMAKE_EXE_LINKER_FLAGS=" -static  -target x86_64-linux-llvm -stdlib=libc++ --rtlib=compiler-rt -unwind=libunwind" \
  -DCMAKE_SHARED_LINKER_FLAGS=" -static  -target x86_64-linux-llvm -stdlib=libc++ --rtlib=compiler-rt -unwind=libunwind" \
  -DCMAKE_BUILD_TYPE=MinSizeRel \
