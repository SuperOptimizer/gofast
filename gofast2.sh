...
cmake -G Ninja "${SRC_DIR}/llvm-project/llvm" \
    ...
    -DRUNTIMES_x86_64-linux-llvm_COMPILER_RT_BUILD_SANITIZERS=OFF \
    ...
    -DRUNTIMES_x86_64-unknown-linux-llvm_COMPILER_RT_BUILD_CRT=ON \
    -DRUNTIMES_x86_64-unknown-linux-llvm_COMPILER_RT_BUILD_LIBFUZZER=OFF \
    -DRUNTIMES_x86_64-unknown-linux-llvm_COMPILER_RT_BUILD_MEMPROF=OFF \
    -DRUNTIMES_x86_64-unknown-linux-llvm_COMPILER_RT_BUILD_SANITIZERS=OFF \
    -DRUNTIMES_x86_64-unknown-linux-llvm_COMPILER_RT_BUILD_XRAY=OFF \
    -DRUNTIMES_x86_64-unknown-linux-llvm_COMPILER_RT_ENABLE_EXCEPTIONS=OFF \
    -DRUNTIMES_x86_64-unknown-linux-llvm_COMPILER_RT_ENABLE_PIC=OFF \
    -DRUNTIMES_x86_64-unknown-linux-llvm_COMPILER_RT_ENABLE_SHARED=OFF \
    -DRUNTIMES_x86_64-unknown-linux-llvm_COMPILER_RT_ENABLE_STATIC=ON \
    -DRUNTIMES_x86_64-unknown-linux-llvm_COMPILER_RT_TARGET_TRIPLE="x86_64-linux-llvm" \
    -DRUNTIMES_x86_64-unknown-linux-llvm_COMPILER_RT_USE_BUILTINS_LIBRARY=OFF \
    -DRUNTIMES_x86_64-unknown-linux-llvm_COMPILER_RT_USE_COMPILER_RT=ON \
    -DRUNTIMES_x86_64-unknown-linux-llvm_LIBCXXABI_ENABLE_EXCEPTIONS=OFF \
    -DRUNTIMES_x86_64-unknown-linux-llvm_LIBCXXABI_ENABLE_PIC=OFF \
    -DRUNTIMES_x86_64-unknown-linux-llvm_RUNTIMES_x86_64-linux-llvm_LIBCXXABI_ENABLE_SHARED=OFF \
    -DRUNTIMES_x86_64-unknown-linux-llvm_LIBCXXABI_ENABLE_STATIC=ON \
    -DRUNTIMES_x86_64-unknown-linux-llvm_LIBCXXABI_ENABLE_STATIC_UNWINDER=ON \
    -DRUNTIMES_x86_64-unknown-linux-llvm_LIBCXXABI_HAS_CXA_THREAD_ATEXIT_IMPL=OFF \
    -DRUNTIMES_x86_64-unknown-linux-llvm_LIBCXXABI_HAS_GCC_S_LIB=OFF \
    -DRUNTIMES_x86_64-unknown-linux-llvm_LIBCXXABI_INSTALL_LIBRARY=ON \
    -DRUNTIMES_x86_64-unknown-linux-llvm_LIBCXXABI_TARGET_TRIPLE="x86_64-linux-llvm" \
    -DRUNTIMES_x86_64-unknown-linux-llvm_LIBCXXABI_USE_COMPILER_RT=ON \
    -DRUNTIMES_x86_64-unknown-linux-llvm_LIBCXXABI_USE_LLVM_UNWINDER=ON \
    -DRUNTIMES_x86_64-unknown-linux-llvm_LIBCXX_ABI_VERSION=2 \
    ...
    -DRUNTIMES_x86_64-unknown-linux-llvm_LIBCXX_ENABLE_PIC=OFF \
    -DRUNTIMES_x86_64-unknown-linux-llvm_LIBCXX_ENABLE_RANDOM_DEVICE=OFF \
    -DRUNTIMES_x86_64-unknown-linux-llvm_LIBCXX_ENABLE_SHARED=OFF \
    -DRUNTIMES_x86_64-unknown-linux-llvm_LIBCXX_ENABLE_STATIC=ON \
    -DRUNTIMES_x86_64-unknown-linux-llvm_LIBCXX_ENABLE_STATIC_ABI_LIBRARY=ON \
    -DRUNTIMES_x86_64-unknown-linux-llvm_LIBCXX_ENABLE_THREADS=OFF \
    -DRUNTIMES_x86_64-unknown-linux-llvm_LIBCXX_ENABLE_WIDE_CHARACTERS=OFF \
    -DRUNTIMES_x86_64-unknown-linux-llvm_LIBCXX_HARDENING_MODE="none" \
    -DRUNTIMES_x86_64-unknown-linux-llvm_LIBCXX_HAS_ATOMIC_LIB=OFF \
    -DRUNTIMES_x86_64-unknown-linux-llvm_LIBCXX_HAS_GCC_S_LIB=OFF \
    -DRUNTIMES_x86_64-unknown-linux-llvm_LIBCXX_HAS_MUSL_LIBC=ON \
    -DRUNTIMES_x86_64-unknown-linux-llvm_LIBCXX_INSTALL_LIBRARY=ON \
    -DRUNTIMES_x86_64-unknown-linux-llvm_LIBCXX_STATIC_SHARED=ON \
    -DRUNTIMES_x86_64-unknown-linux-llvm_LIBCXX_TARGET_TRIPLE="x86_64-linux-llvm" \
    -DRUNTIMES_x86_64-unknown-linux-llvm_LIBCXX_USE_COMPILER_RT=ON \
    -DRUNTIMES_x86_64-unknown-linux-llvm_LIBC_ENABLE_EXCEPTIONS=OFF \
    -DRUNTIMES_x86_64-unknown-linux-llvm_LIBC_ENABLE_SHARED=OFF \
    -DRUNTIMES_x86_64-unknown-linux-llvm_LIBC_ENABLE_STATIC=ON \
    -DRUNTIMES_x86_64-unknown-linux-llvm_LIBC_ENABLE_USE_BY_CLANG=ON \
    -DRUNTIMES_x86_64-unknown-linux-llvm_LIBC_TARGET_TRIPLE="x86_64-linux-llvm" \
    -DRUNTIMES_x86_64-unknown-linux-llvm_LIBC_USE_COMPILER_RT=ON \
    -DRUNTIMES_x86_64-unknown-linux-llvm_LIBUNWIND_ENABLE_EXCEPTIONS=OFF \
    -DRUNTIMES_x86_64-unknown-linux-llvm_LIBUNWIND_ENABLE_PIC=OFF \
    -DRUNTIMES_x86_64-unknown-linux-llvm_LIBUNWIND_ENABLE_SHARED=OFF \
    -DRUNTIMES_x86_64-unknown-linux-llvm_LIBUNWIND_ENABLE_STATIC=ON \
    -DRUNTIMES_x86_64-unknown-linux-llvm_LIBUNWIND_FORCE_UNWIND_TABLES=OFF \
    -DRUNTIMES_x86_64-unknown-linux-llvm_LIBUNWIND_HAS_GCC_S_LIB=OFF \
    -DRUNTIMES_x86_64-unknown-linux-llvm_LIBUNWIND_INSTALL_LIBRARY=ON \
    -DRUNTIMES_x86_64-unknown-linux-llvm_LIBUNWIND_TARGET_TRIPLE="x86_64-linux-llvm" \
