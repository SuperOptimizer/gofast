...
-DCMAKE_TOOLCHAIN_FILE="/home/forrest/gofast/x86_64-linux-llvm.cmake" \
-DCMAKE_CXX_FLAGS=" -static  -w -fuse-ld=lld --rtlib=compiler-rt -unwind=libunwind -stdlib=libc++  -march=native -Os -g0" \
-DCMAKE_C_FLAGS=" -static -w -fuse-ld=lld --rtlib=compiler-rt -unwind=libunwind  -march=native -Os -g0" \
-DCMAKE_EXE_LINKER_FLAGS=" -static -fuse-ld=lld --rtlib=compiler-rt -unwind=libunwind -stdlib=libc++ " \
...
-DCMAKE_INSTALL_PREFIX="/home/forrest/sysroot2" \
